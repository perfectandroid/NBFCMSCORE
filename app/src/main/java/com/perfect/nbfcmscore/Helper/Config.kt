...
//    val CERT_NAME = "staticvm.pem"  //QA
    ...
    //UPI SECTION
    const val SHARED_PREF347 = "AceMoneyUserID" // LoginOTP / MPIN
    const val SHARED_PREF348 = "AceMoneyUPIID" // LoginOTP / MPIN
    const val SHARED_PREF349 = "KItNumber" // LoginOTP / MPIN
    const val SHARED_PREF350 = "AceMoneyUpiBankCode" // Reseller
    const val SHARED_PREF351 = "AgentEmail" // Reseller
    const val SHARED_PREF352 = "UpiDetlsArray"
    const val SHARED_PREF353 = "UPIPinSET"
    const val SHARED_PREF354 = "UPIAccNo"
    ...
    fun getSSLSocketFactory(context: Context): SSLSocketFactory {
        ...
        val sslcertificateSP =
            context.applicationContext.getSharedPreferences(Config.SHARED_PREF164, 0)
