...
class FundtransferAdapter(internal val mContext: Context, internal val jsInfo: JSONArray): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): RecyclerView.ViewHolder {
        ...
        val v = LayoutInflater.from(parent.context).inflate(
            R.layout.adapter_fundtransfer_status, parent, false
        )
        vh = MainViewHolder(v)
        return vh
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is FundtransferAdapter.MainViewHolder) {
