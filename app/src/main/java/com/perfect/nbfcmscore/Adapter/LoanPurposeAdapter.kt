...
class LoanPurposeAdapter (internal val mContext: Context, internal val jsInfo: JSONArray): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        try {
            ...
            if (holder is LoanPurposeAdapter.MainViewHolder) {
                holder.tv_adp_emi!!.setText(jsonObject!!.getString("LoanPurpose"))

                holder.ll_adp_emi!!.setOnClickListener(View.OnClickListener {
                    clickListener!!.onClick(position,"purpose")
