...
class BarcodeMain : AppCompatActivity() {
                ...
                if (qrcode?.size() != 0) {
                    try {
                        ...
                        handler.post {
                            ...
                            startActivity(Intent(context, UpiMain::class.java).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP).putExtra("upi",value1).putExtra("from","barcode"))
//                            val in = Intent(this@BarcodeMain, Upi_main::class.java)
//                            in.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
//                            in.putExtra("upi", value1)
//                            in.putExtra("from", "barcode")
//                            startActivity(`in`)
                            finish()
                            // insert(value1);
                        }
