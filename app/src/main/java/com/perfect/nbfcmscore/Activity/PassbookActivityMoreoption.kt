...
class PassbookActivityMoreoption : AppCompatActivity(), OnItemSelectedListener,View.OnClickListener {
    ...
    private fun getPassBookAccountStatement() {
        ...
        when(ConnectivityUtils.isConnected(this)) {
            true -> {
                ...
                try {
                    ...
                    try {
                        ...
                        progressDialog!!.dismiss()
                        e.printStackTrace()
                        AlertMessage().alertMessage(this@PassbookActivityMoreoption,this@PassbookActivityMoreoption,"Alert","Some technical issues.",1);
                    }
                    val body = RequestBody.create(
                        "application/json; charset=utf-8".toMediaTypeOrNull(),
                        requestObject1.toString()
                        ...
                        override fun onResponse(
                            ...
                            try {
                                ...
                                if (jObject.getString("StatusCode") == "0") {
                                    ...
                                    AlertMessage().alertMessage(this@PassbookActivityMoreoption,this@PassbookActivityMoreoption,"Alert",jObject.getString("EXMessage"),1);
                                }
                            } catch (e: Exception) {
                                progressDialog!!.dismiss()
            ...
            false -> {
                AlertMessage().alertMessage(this@PassbookActivityMoreoption,this@PassbookActivityMoreoption,"Alert"," No Internet Connection. ",3);
            }
        }
    }
