...
class HolidayListActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener,
    ...
    private fun getBranchlist() {
        ...
        when (ConnectivityUtils.isConnected(this)) {
            true -> {
                ...
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        AlertMessage().alertMessage(this@HolidayListActivity,this@HolidayListActivity,"Alert","Some technical issues.",1);
                    }
                        ...
                        override fun onResponse(
                            ...
                            try {
                                ...
                                if (jObject.getString("StatusCode") == "0") {
                                    ...
                                    AlertMessage().alertMessage(this@HolidayListActivity,this@HolidayListActivity,"Alert",jObject.getString("EXMessage"),1);
                                }
                            } catch (e: Exception) {
                                //  progressDialog!!.dismiss()
                                AlertMessage().alertMessage(this@HolidayListActivity,this@HolidayListActivity,"Alert","Some technical issues.",1);
            ...
            false -> {
                AlertMessage().alertMessage(this@HolidayListActivity,this@HolidayListActivity,"Alert","No Internet Connection.",3);
            }
        }
    }
