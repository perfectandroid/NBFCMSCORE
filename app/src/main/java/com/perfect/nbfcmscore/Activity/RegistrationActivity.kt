...
//        Glide.with(this).load(IMAGRURL).placeholder(null).into(imgLogo);
        PicassoTrustAll.getInstance(this@RegistrationActivity)!!.load(imagepath)
    ...
    private fun validation() {
        ...
        } else if (etxt_accno!!.text.toString()
                .isNotEmpty() && etxt_accno!!.text.toString().length != 4
        ) {
    ...
    private fun setUrl() {
        ...
        if (strTestmobile.equals(mobileNumber)) {
            ...
            val TestingImageURLSP =
                applicationContext.getSharedPreferences(Config.SHARED_PREF317, 0)
            ...
            val sslcertificatetestSP =
                applicationContext.getSharedPreferences(Config.SHARED_PREF318, 0)
            ...
            ImageURLSPEditer.putString(
                "ImageURL",
                TestingImageURLSP.getString("TestingImageURL", null)
            )
            ...
            BankHeaderEditer.putString(
                "BankHeader",
                TestBankHeaderSP.getString("testBankHeader", null)
            )
            ...
            certificateSPEditer.putString(
                "sslcertificate",
                sslcertificatetestSP.getString("testsslcertificate", null)
            )
            ...
            true -> {
                ...
                try {
                    ...
                    try {
                        ...
                        requestObject1.put(
                            "MobileNumber",
                            MscoreApplication.encryptStart(etxt_mob!!.text.toString())
                        )
                        requestObject1.put(
                            "AccountNumber",
                            MscoreApplication.encryptStart(etxt_accno!!.text.toString())
                        )
...
//                                    alertDialog.show()
    ...
    fun alertMessage(header: String, message: String, type: Int, jobjt: JSONObject) {
        ...
        txt_cancel!!.setOnClickListener {
            ...
            val jobjt = jobjt.getJSONObject("CustomerRegistration")
            intent = Intent(applicationContext, OTPActivity::class.java)
            intent.putExtra("FK_Customer", jobjt.getString("FK_Customer"))
            intent.putExtra("Token", jobjt.getString("Token"))
            intent.putExtra("CusMobile", jobjt.getString("CusMobile"))
