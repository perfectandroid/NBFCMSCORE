...
//    https://www.journaldev.com/22475/android-retrofit-download-file-progress
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtv_slctcustomdte!!.setText(
            ID_customdate.getString(
...
//                                    act_district!!.showDropDown()
    ...
    private fun validation() {
        ...
        var FromNo = AccountNumber!!.replace(
                            ...
                            try {
                                ...
                                if (jObject.getString("StatusCode") == "0") {
                                    val jsonObj1: JSONObject =
                                        jObject.getJSONObject("StatementOfAccountDet")
...
//                                    var filename3 ="https://202.164.150.65:15006/NbfcMscoreDbAPI/Statement/PerfectBank/DDSB002001000052.pdf"
    ...
    private fun downloadFile(filename1: String, filename2: String) {
        ...
        //  val downloadManager = getSystemService(Context.DOWNLOAD_SERVICE) as DownloadManager
        val manager: com.coolerfall.download.DownloadManager? =
            com.coolerfall.download.DownloadManager.Builder().context(this)
                .downloader(OkHttpDownloader.create(client))
                .threadPoolSize(3)
                .logger(object : Logger {
                    override fun log(message: String?) {
