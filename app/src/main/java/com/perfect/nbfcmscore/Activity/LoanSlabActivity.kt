...
class LoanSlabActivity : AppCompatActivity()  , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_loanslab)
    ...
    private fun getStandingInstruction() {
        ...
        when(ConnectivityUtils.isConnected(this)) {
            true -> {
                ...
                try {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        AlertMessage().alertMessage(this@LoanSlabActivity,this@LoanSlabActivity,"Alert","Some technical issues.",1);
                    }
                    val body = RequestBody.create(
                        "application/json; charset=utf-8".toMediaTypeOrNull(),
                        requestObject1.toString()
                    )
                    val call = apiService.getLoanSlabDetails(body)
                        ...
                        override fun onResponse(
                            ...
                            try {
                                ...
                                if (jObject.getString("StatusCode") == "0") {
                                    ...
                                    AlertMessage().alertMessage(this@LoanSlabActivity,this@LoanSlabActivity,"Alert",jObject.getString("EXMessage"),1);
                                }                            } catch (e: Exception) {
                                progressDialog!!.dismiss()
                                AlertMessage().alertMessage(this@LoanSlabActivity,this@LoanSlabActivity,"Alert","Some technical issues.",1);
                                e.printStackTrace()
            ...
            false -> {
                AlertMessage().alertMessage(this@LoanSlabActivity,this@LoanSlabActivity,"Alert","No Internet Connection.",3);
            }
        }
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.imgHome ->{
                startActivity(Intent(this@LoanSlabActivity, HomeActivity::class.java))
            }
        }
    }
